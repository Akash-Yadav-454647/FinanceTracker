...
export function useTransactions() {
  ...
  const addTransaction = async (transaction: Omit<Transaction, "id">) => {
    // Create a temporary ID for non-authenticated users or fallback
    ...
    try {
      ...
      // Ensure we're using the UUID returned from Supabase
      const persistedTransaction: Transaction = {
        ...transaction,
        id: data.id, // This is the UUID generated by Supabase
      };
